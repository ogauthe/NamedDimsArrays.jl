...
function Base.eachindex(::NamedIndexCartesian, a1::AbstractArray, a_rest::AbstractArray...)
    all(a -> issetequal(nameddimsindices(a1), nameddimsindices(a)), a_rest) ||
        throw(
        NameMismatch("Dimension name mismatch $(nameddimsindices.((a1, a_rest...))).")
    )
...
using Base.Broadcast: AbstractArrayStyle, Broadcasted, broadcast_shape, broadcasted,
