---
name: NamedDimsArrays.jl bug report
about: Create a bug report to help us improve NamedDimsArrays.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("NamedDimsArrays")`:
```julia
julia> using Pkg; Pkg.status("NamedDimsArrays")
[YOUR OUTPUT HERE]
```
